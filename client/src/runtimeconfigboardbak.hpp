...
class ProcessRun;
class RuntimeConfigBoard_bak: public Widget
{
    private:
                    ...
                    : TritexButton
                      {
                          ...
                          [this](ButtonBase *)
                          {
                              ...
                              for(auto parentPtr = parent(); parentPtr; parentPtr = parentPtr->parent()){
                                  if(auto configBoardPtr = dynamic_cast<RuntimeConfigBoard_bak *>(parentPtr)){
    ...
    public:
        RuntimeConfigBoard_bak(int, int, ProcessRun *, Widget * = nullptr, bool = false);
