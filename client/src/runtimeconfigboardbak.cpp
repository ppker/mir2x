...
#include "runtimeconfigboardbak.hpp"
...
void RuntimeConfigBoard_bak::drawEx(int dstX, int dstY, int, int, int, int) const
{
...
bool RuntimeConfigBoard_bak::processEvent(const SDL_Event &event, bool valid)
{
    if(!valid){
...
void RuntimeConfigBoard_bak::drawEntryTitle(const char8_t *info, int dstCenterX, int dstCenterY) const
{
...
std::tuple<int, int, int, int> RuntimeConfigBoard_bak::getEntryPLoc(size_t entry)
{
    if(entry < 12){
...
void RuntimeConfigBoard_bak::setConfig(SDRuntimeConfig config)
{
...
void RuntimeConfigBoard_bak::reportRuntimeConfig()
{
